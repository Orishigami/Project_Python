...
def detect_objects(frame, camera_rois=None):
    ...
    for out in outs:
        for detection in out:
            ...
            if confidence > 0.5 and classes[class_id] == "car":
                ...
                # ถ้าไม่มี ROI หรือกล่องอยู่ในพื้นที่ ROI ใดๆ จึงจะเพิ่มเข้าไป
                box = [x, y, w, h]
                if camera_rois is None:
                    boxes.append(box)
    ...
    while True:
        for i, camera in enumerate(cameras):
            ...
            if ret:
                ...
                detected_boxes = detect_objects(resized_frame, rois.get(i, None))
